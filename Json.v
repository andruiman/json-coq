...
REMOVE (by purge) "type" AT "."

UNFOLD (by disjoin, indexate) AT "name"  -- on lists 
DESTRUCT (by renaming, concat suffix "name*") AT "name*" -- on maps
JOIN (by concat, with delimiter " ") AT "given*" -- on  lists

UNFOLD (by disjoin, indexate) AT "telecom"
CONSTRUCT (by replace {@"system" # @"value"}) AT "telecom*"
DESTRUCT (by renaming, concat suffix "telecom*") AT "telecom*"
*)

(*
json3 -> json2
FOLD (by joining, of "phone*") AT "phone"
FOLD (by joining, of "mail*") AT "mail"
FOLD (by joining, of "family*") AT "family"
FOLD (by joining, of "given*") AT "given"
CONSTRUCT (by replace, {"name" # '["given" # @given, "family" # @family]}) AT "."
CONSTRUCT (by replace, {"telecom" # '["given" # @given, "family" # @family]}) AT "."
